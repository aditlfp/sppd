                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('eslons.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="mt-1 block w-full border-gray-300 rounded-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required placeholder="Masukkan nama eselon (Eselon I, Eselon II, dst)">
                        </div>
