...
<div id="fullscreen-menu"
    ...
    <div id="divIsi"
        class="flex flex-col gap-2 items-start ml-[30%] mt-[45%] h-full transition-all transform -translate-x-10 duration-1000 ease-in-out opacity-0">
        <a href="{{ route('dashboard') }}" class="text-white font-bold text-xl flex items-center gap-2"><svg
        ...
        <a href="{{ route('main_sppds.index') }}" class="text-white font-bold text-xl flex items-center gap-2"><svg
                xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
                <path
        ...
        @if (auth()->user()->role->name == 'admin')
            <a href="{{ route('eslons.index') }}" class="text-white font-bold text-xl flex items-center gap-2"><svg
                    xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <a href="{{ route('pocket_moneys.index') }}"
                class="text-white font-bold text-xl flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <form method="POST" action="{{ route('logout') }}" class="mt-3">
            @csrf
            <button type="submit" class="text-white font-bold text-xl flex items-center gap-2"><svg
                    xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
                    <path
