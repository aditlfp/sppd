    ...
    <ul class="menu rounded-sm text-base">
        ...
        <li>
            <a href="{{ route('dashboard') }}"
                class="font-medium flex items-center gap-2 {{ Route::is('dashboard') ? 'bg-blue-500 text-white' : '' }}"><svg
        ...
        <li>
            <details {{ Route::is('main_sppds.index') || Route::is('main_sppds.create') ? 'open' : '' }}>
                <summary
                    class="font-medium flex items-center justify-between gap-2 {{ Route::is('main_sppds.index') || Route::is('main_sppds.create') ? 'bg-blue-500 text-white' : '' }}">
                ...
                <ul>
                    <li>
                        <a href="{{ route('main_sppds.index') }}"
                            class=" font-medium  {{ Route::is('main_sppds.index') ? 'link' : '' }}">Index</a>
                        <a href="{{ route('main_sppds.create') }}"
                            class=" font-medium  {{ Route::is('main_sppds.create') ? 'link' : '' }}">Create</a>
                    </li>
                </ul>
            </details>
        </li>
        <li>
            <details {{ Route::is('eslons.index') || Route::is('eslons.create') ? 'open' : '' }}>
                <summary
                    class="font-medium flex items-center justify-between gap-2 {{ Route::is('eslons.index') || Route::is('eslons.create') ? 'bg-blue-500 text-white' : '' }}">
                    <span class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
                            <path
                ...
                <ul>
                    <li>
                        <a href="{{ route('eslons.index') }}"
                            class=" font-medium  {{ Route::is('eslons.index') ? 'link' : '' }}">Index</a>
                        <a href="{{ route('eslons.create') }}"
                            class=" font-medium  {{ Route::is('eslons.create') ? 'link' : '' }}">Create</a>
                    </li>
                </ul>
            </details>
        </li>
        <li>
            <details {{ Route::is('pocket_moneys.index') || Route::is('pocket_moneys.create') ? 'open' : '' }}>
                <summary
                    class="font-medium flex items-center justify-between gap-2 {{ Route::is('pocket_moneys.index') || Route::is('pocket_moneys.create') ? 'bg-blue-500 text-white' : '' }}">
                    <span class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
                            <path
                ...
                <ul>
                    <li>
                        <a href="{{ route('pocket_moneys.index') }}"
                            class=" font-medium  {{ Route::is('pocket_moneys.index') ? 'link' : '' }}">Index</a>
                        <a href="{{ route('pocket_moneys.create') }}"
                            class=" font-medium  {{ Route::is('pocket_moneys.create') ? 'link' : '' }}">Create</a>
                    </li>
                </ul>
            </details>
        </li>
        <li>
            <details {{ Route::is('transportations.index') || Route::is('transportations.create') ? 'open' : '' }}>
                <summary
                    class="font-medium flex items-center justify-between gap-2 {{ Route::is('transportations.index') || Route::is('transportations.create') ? 'bg-blue-500 text-white' : '' }}">
                    <span class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
                            <path
                ...
                <ul>
                    <li>
                        <a href="{{ route('transportations.index') }}"
                            class=" font-medium  {{ Route::is('transportations.index') ? 'link' : '' }}">Index</a>
                        <a href="{{ route('transportations.create') }}"
                            class=" font-medium  {{ Route::is('transportations.create') ? 'link' : '' }}">Create</a>
                    </li>
                </ul>
            </details>
        </li>
        <li class="">
            <form method="POST" action="{{ route('logout') }}" class="bg-blue-500 text-white rounded-sm">
                @csrf
