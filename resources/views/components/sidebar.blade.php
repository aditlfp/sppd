    ...
    <ul class="menu rounded-sm text-base">
        ...
        <li>
            <a href="{{ route('dashboard') }}"
                class="font-medium flex items-center gap-2 {{ Route::is('dashboard') ? 'bg-blue-500 hover:bg-blue-600 text-white' : '' }}"><svg
                ...
                <ul>
                    <li>
                        <a href="{{ route('main_sppds.index') }}"
                            class=" font-medium  {{ Route::is('main_sppds.index') ? 'link' : '' }}">Data SPPD</a>
                        <a href="{{ route('main_sppds.create') }}"
                            class=" font-medium  {{ Route::is('main_sppds.create') ? 'link' : '' }}">Tambah SPPD</a>
                    </li>
                </ul>
            </details>
        </li>
                ...
                <ul>
                    <li>
                        <a href="{{ route('eslons.index') }}"
                            class=" font-medium  {{ Route::is('eslons.index') ? 'link' : '' }}">Data Eselon</a>
                        <a href="{{ route('eslons.create') }}"
                            class=" font-medium  {{ Route::is('eslons.create') ? 'link' : '' }}">Tambah Eselon</a>
                    </li>
                </ul>
            </details>
        </li>
                ...
                <ul>
                    <li>
                        <a href="{{ route('regions.index') }}"
                            class=" font-medium  {{ Route::is('regions.index') ? 'link' : '' }}">Data Wilayah</a>
                        <a href="{{ route('regions.create') }}"
                            class=" font-medium  {{ Route::is('regions.create') ? 'link' : '' }}">Tambah Wilayah</a>
                    </li>
                </ul>
            </details>
        </li>
        ...
        <li class="">
            <form method="POST" action="{{ route('logout') }}" class="bg-blue-500 hover:bg-blue-600 text-white rounded-sm">
                @csrf
