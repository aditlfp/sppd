                    ...
                    <ul>
                        <li>
                            <a href="{{ route('main_sppds.index') }}"
                                class=" font-medium rounded-sm {{ Route::is('main_sppds.index') ? 'link' : '' }}">Data SPPD</a>
                            <a href="{{ route('main_sppds.create') }}"
                                class=" font-medium rounded-sm {{ Route::is('main_sppds.create') ? 'link' : '' }}">Tambah SPPD</a>
                        </li>
                    </ul>
                </details>
            </li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('eslons.index') }}"
                                class=" font-medium rounded-sm {{ Route::is('eslons.index') ? 'link' : '' }}">Data Eselon</a>
                            <a href="{{ route('eslons.create') }}"
                                class=" font-medium rounded-sm {{ Route::is('eslons.create') ? 'link' : '' }}">Tambah Eselon</a>
                        </li>
                    </ul>
                </details>
            </li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('pocket_moneys.index') }}"
                                class=" font-medium rounded-sm {{ Route::is('pocket_moneys.index') ? 'link' : '' }}">Data Uang
                                Saku</a>
                            <a href="{{ route('pocket_moneys.create') }}"
                                class=" font-medium rounded-sm {{ Route::is('pocket_moneys.create') ? 'link' : '' }}">Tambah Uang
                                Saku</a>
                        </li>
                    </ul>
                </details>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('regions.index') }}"
                                class=" font-medium rounded-sm {{ Route::is('regions.index') ? 'link' : '' }}">Data Wilayah</a>
                            <a href="{{ route('regions.create') }}"
                                class=" font-medium rounded-sm {{ Route::is('regions.create') ? 'link' : '' }}">Tambah Wilayah</a>
                        </li>
                    </ul>
                </details>
            </li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('transportations.index') }}"
                                class=" font-medium rounded-sm {{ Route::is('transportations.index') ? 'link' : '' }}">Data
                                Transportasi</a>
