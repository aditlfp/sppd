                    ...
                    @class([
                        ...
                        <form action="{{ route('main_sppds.update', $mainSppd->id) }}" method="POST" class="form-control" enctype="multipart/form-data">
                            ...
                            <div class="border border-gray-200 p-4">
                                ...
                                <div class="mb-4" x-data="filePreview('{{ storage_path($datas->foto_arrive ? 'app/public/images/' . $datas->foto_arrive : 'img/no-image.jpg') }}')">
                            ...
                            <div class="border border-gray-200 p-4 mt-4">
                                ...
                                <div class="mb-4" x-data="filePreview2('{{ storage_path($datas->foto_destination ? 'app/public/images/' . $datas->foto_destination : 'img/no-image.jpg') }}')">
