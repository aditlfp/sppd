@if (Route::is('verify_page.*'))
    <h2 class="font-semibold text-md sm:text-xl text-gray-800 leading-tight bg-gray-200 rounded-sm p-4">
        Bukti Keberangkatan & Kedatangan parte 1
    </h2>
@endif
                ...
                <form action="{{ route('main_sppds.update', $mainSppd->id) }}" method="POST" class="form-control" enctype="multipart/form-data">
                    ...
                    <div class="border border-gray-200 p-4 mt-4">
                        <div class="mb-4">
                            ...
                            <input type="text" name="departed_at" id="departed_at" class="mt-1 block w-full input input-sm input-bordered text-xs rounded-sm" placeholder="Berangkat dari...">
                        </div>
...
<script>
     document.addEventListener('DOMContentLoaded', function () {
            initializeMap('map1', 'maps_tiba');
            initializeMap('map2', 'maps_tujuan');
        });
